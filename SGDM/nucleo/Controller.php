...
abstract class Controller {
     ...
     *
     * @param string $view Ruta lógica de la plantilla, p. ej. 'documentacion'.
    ...
    /**
     * Sirve una página .html de la capa Vista (Controlador → Vista).
     *
     * Las páginas estáticas viven en SGDM/vista, fuera del DocumentRoot, así
     * que Apache no puede servirlas por su cuenta: pasan por acá una vez que
     * el controlador validó el acceso.
     *
     * @param string $view Ruta lógica sin extensión, p. ej. 'paneles/perfil'.
     */
    protected function html(string $view): void {
        $this->view->html($view);
    }
