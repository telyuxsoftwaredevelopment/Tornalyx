...
require_once __DIR__ . '/../modelo/Torneo.php';
require_once __DIR__ . '/../modelo/Partido.php';
require_once __DIR__ . '/../modelo/Posicion.php';
...
class PerfilController extends Controller {
     ...
     * almacenamiento persistente, y cualquier archivo escrito en el disco del
     * contenedor desaparece en el próximo redeploy) y se sirve vía servirAvatar().
     */
