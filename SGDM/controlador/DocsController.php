...
require_once __DIR__ . '/../modelo/DocAcceso.php';
require_once __DIR__ . '/../modelo/DocOtp.php';
...
class DocsController extends Controller {
    ...
    private function obtenerContenido(string $slug, string $url): array {
        $dirLocal = __DIR__ . '/../vista/docs';
        $fileLocal = $dirLocal . '/' . $slug . '.html';

        $dirCache = __DIR__ . '/../almacenamiento/docs-cache';
        ...
        // 3 · Fallback 1: documento local versionado en vista/docs/
        if (is_file($fileLocal)) {
            return [(string) file_get_contents($fileLocal), null];
        }
