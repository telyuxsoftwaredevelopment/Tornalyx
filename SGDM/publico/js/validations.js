  ...
  form.addEventListener('submit', async function (e) {
    ...
    try {
      ...
      if (json.success && json.twofa) {
        ...
        /* En desarrollo sin correo configurado el backend omite el segundo
           factor y avisa por qué; se muestra para que no parezca un fallo
           silencioso del 2FA. */
        if (json.aviso && window.Tornalyx?.Toast) window.Tornalyx.Toast.warning(json.aviso);
